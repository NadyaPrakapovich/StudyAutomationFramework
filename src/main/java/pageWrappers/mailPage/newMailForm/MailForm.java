...
public class MailForm {
	...
	public static final By FORM_PROGRESSBAR_LOCATOR = By.cssSelector(".LoadingProgress__progress--10oXR");
	public static final By ALERT_ABOUT_MAIL_WAS_SEND_LOCATOR = By.cssSelector(".ComposeDoneScreen-Wrapper");
	...
	public static Button getAttachFile() {	return new Button(BUTTON_ATTACH_LOCATOR);	}
