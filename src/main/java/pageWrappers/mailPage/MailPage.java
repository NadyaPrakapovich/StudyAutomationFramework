...
public class MailPage {
	...
	private static final By PANEL_SAVE_TO_DISK = By.xpath("(//div[@class='mail-MessageSnippet-Item mail-MessageSnippet-Item_attachmentsFiles'])[1]");
	private static final By BUTTON_DISK_LOCATOR = By.cssSelector(".PSHeaderIcon-Image_Disk");

	private static final By NAME_FILE_IN_MAIL_LOCATOR = By.xpath("(//span[@class='mail-File-Actions'])[1]");
	//	public static final By LIST_ATTACH_FILE_LOCATOR =By.xpath("//span[@class=\"mail-File-Actions\"]");

	public static Button getNewMail() {
		return new Button(NEW_MAIL_LINK_LOCATOR);
	}
	...
	public static HtmlElement getIframeToSaveDick() {
		return new HtmlElement(IFRAME_SAVE_DISK_OK_LOCATOR);
	}
	...
	public static HtmlElement getPanelSaveFile() {
	...
	public static HtmlElement getNameFile() {
		return new HtmlElement(NAME_FILE_IN_MAIL_LOCATOR);
	}
}
